...
export class TickerService {
	...
	KiteTicker = function(api_key, user_id, public_token, address) {
		var read_timeout: any = 5, // seconds
		...
		this.connect = function() {
			...
			ws.onopen = function() {
				...
				read_timer = setInterval(function() {
					if(read_timeout < ((new Date() - last_read ) / 1000)) {
