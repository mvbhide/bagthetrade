...
export class CurrentOrdersComponent implements OnInit {
			...
			for(let i=0; i<this.clubbedOrders['primaryOrders'].length; i++) {
				...
				for(let j=0; j<tickdata.length;j++) {
					if(this.clubbedOrders['primaryOrders'][i]['instrument_token'] == tickdata[j]['Token']) {
						...
						// Multiplying quantity by 10 temporarily to test with crudeoil mini
						// Need to add multiplier stored in db for commodities
	...
	orders: Array<object> = [{
		...
		"exchange" : "MCX",
		"exchange_order_id" : "211806600243367",
		"exchange_timestamp" : "2018-03-07 1::7",
		"exchange_update_timestamp" : null,
		"filled_quantity" : 1,
		"guid" : "6N8XHe6IdhL1Ey1P",
		"instrument_token" : 53511687,
		"market_protection" : 0,
		"order_id" : "180307001831132",
		"order_timestamp" : "2018-03-07 1::7",
		"order_type" : "LIMIT",
		...
		"status_message" : null,
		"tag" : null,
		"tradingsymbol" : "CRUDEOILM18MARFUT",
		...
		"disclosed_quantity" : 0,
		"exchange" : "MCX",
		"exchange_order_id" : "231806600301126",
		"exchange_timestamp" : "2018-03-07 1::7",
		"exchange_update_timestamp" : null,
		"filled_quantity" : 0,
		"guid" : null,
		"instrument_token" : 53511687,
		"market_protection" : 0,
		"order_id" : "180307001831133",
		"order_timestamp" : "2018-03-07 1::7",
		"order_type" : "SL-M",
		"parent_order_id" : "180307001831132",
		"pending_quantity" : 1,
		"placed_by" : "RP6292",
		"price" : 0,
		"product" : "CO",
